...
import expectReviewInDatabaseToBeUpdated from "@/tests/API/helpers/destinations/reviews/update/expectReviewInDatabaseToBeUpdated";
import expectReviewInDatabaseToBeNOTUpdated from "@/tests/API/helpers/destinations/reviews/update/expectReviewInDatabaseToBeNOTUpdated";
// Mocks
...
describe("PATCH: /api/destination/[destination_id]/reviews/[review_id]", () => {
